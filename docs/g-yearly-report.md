...
**Applied response:** use the [Complete Backup and Recovery Manifest](complete-backup-and-recovery-manifest.md) and validate restoration as an operational state, not merely as a successful file download.
